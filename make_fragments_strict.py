...
# ---------------------------
# Output files (your required set)
# ---------------------------
FRAG = {
...
# ---------------------------
# Routing keywords (STRICTER)
# You can tweak these lists to adjust routing.
# ---------------------------
...
JS_KEYS: Dict[str, List[str]] = {
    ...
    "admin_nav_top": ["adminLogin", "openAdminDashboard", "switchAdminTab", "buildAdminPanels", "loadAdminMemories", "requireAdmin", "adminToken"],
    ...
    "admin_users": ["renderUsersPanelHtml", "wireUsersPanel", "loadUsers", "createUser", "updateUser", "renderUsersList"],
    "admin_compilations": ["renderCompilationsPanelHtml", "loadCompilationsAdmin", "editCompilationAdmin", "deleteCompilationAdmin"],
    "admin_security": ["renderSecurityPanelHtml", "changeAdminPassword", "resetUploadHashes"],
}
...
# ---------------------------
# Build index template + include expansion
# ---------------------------
